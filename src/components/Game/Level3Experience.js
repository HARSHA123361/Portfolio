    ...
    const experiences = [
        {
            ...
            company: "UF/IFAS | Gainesville, FL",
            date: "Mar 2026 – Present",
            points: [
                "Designed and owned a conversational chatbot platform using Spring Boot & GraphQL APIs, integrating OpenAI API keys & ML-based intent detection with Scikit-learn & XGBoost to deliver accurate, reliable responses for plant science workflows.",
                "Deployed on AWS using EC2, Auto Scaling, CloudWatch, Redis, & Secrets Manager to deliver secure, highly available systems.",
                "Improved system reliability through code reviews, testing, monitoring, and documentation, collaborating with stakeholders and leveraging AI developer tools (Cursor, Windsurf, Claude) to accelerate development."
            ],
            color: '#27AE60'
        },
        {
