...
function Level4Projects() {
    const projects = [
        {
            number: "01",
            title: "Production Schedule Reflow Engine",
            description: "Engineered a TypeScript production scheduling engine using DAG-based topological sorting to resolve multi-level work order dependencies with 100% constraint accuracy. Implemented shift-aware date calculation via Luxon handling maintenance windows and setup times across 3+ complex factory scenarios, achieving zero scheduling conflicts. Integrated automated Jest test coverage validating delay-cascade propagation, cycle detection, and utilization metrics across multi-work-center workflows.",
            tags: ["TypeScript", "Node.js", "Luxon", "Jest", "DAG", "Topological Sort", "Cycle Detection", "Shift Scheduling", "Dependency Resolution", "Utilization Metrics", "TDD", "Constraint Validation"],
            github: "https://github.com/HARSHA123361/production-schedule-reflow",
                ...
                <Row style={{ alignItems: 'stretch' }}>
                    {projects.map((project, index) => (
                        <Col
                            xs={12} md={6}
                            key={index}
                            style={{ marginBottom: '3rem', display: 'flex' }}
                        >
                            <motion.div
                            ...
                            >
                                ...
                                {/* Health Bar */}
                                <div className="boss-health-bar" style={{ flexShrink: 0 }}>
                                    <motion.div
                                ...
                                {/* Project Card — grows to fill remaining height */}
                                <div
                                ...
                                >
                                    ...
                                    {/* Attack Button — pinned to bottom */}
